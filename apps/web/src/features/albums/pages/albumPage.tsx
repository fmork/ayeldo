...
import AlbumUploadDropzone from '../components/AlbumUploadDropzone';
    ...
    <Stack spacing={3} component="section">
      ...
      {albumJobs.length > 0 && (
        <Box>
          ...
          <Stack spacing={1}>
            {albumJobs.map((job) => (
              <Stack key={job.id} spacing={0.5} sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 1, p: 1.5 }}>
